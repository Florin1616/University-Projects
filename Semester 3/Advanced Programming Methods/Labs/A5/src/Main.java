...
//                                        new CompStmt(new ForkStmt(new CompStmt(new WriteHeapStmt("a", new ValueExpression(new IntValue(30))),
...
//        PrgState prg10 = new PrgState(stack7, new MyDictionary<String, ValueInterface>(),  new MyList<Value>(), new MyDictionary<StringValue, BufferedReader>(), new MyHeap<>(), example_7);
